...
- **DHCP stond nog aan op de oude gateway in VLAN 34**: `10.34.0.7`, MAC `0c:ea:14:19:e4:11`, deelde zichzelf uit als gateway + DNS → vanaf het beheerwerkstation was niets meer bereikbaar. Uitgezet 2026-09-15. User heeft daarna de oude gw volledig nagekeken op resterende interfaces en DHCP in andere VLANs (✅ 2026-09-15).
- **De oude gateway staat nog op `.7` in meerdere VLANs** (MAC `0c:ea:14:19:e4:11`, bevestigd 2026-09-15): `10.34.0.7` (DHCP, gefixt), `10.35.0.7`, **`10.21.0.7` = IP-conflict met haproxy-2** → failover stuk (✅ oude gw van `.7` gehaald 2026-09-15; haproxy-2 weer gezond — zie [[project-stepca-cert-incident-202609]]). Na de ingreep antwoorden ook `10.34.0.7` en `10.35.0.7` niet meer (0/3 pings, 13:27); de oude MAC die nog in ARP-tabellen staat is cache. `10.36.0.7` antwoordt niet. **NAS bevestigd**: ook het NAS-adres (`.7`) botste met de oude gw; user haalde het weg 2026-09-15 en bevestigde dat dit de backup-problemen gaf (31/08, [[project-offline-backup-chain]]). Les van 16/06 herhaalt zich: een gateway mag nooit een host-IP innemen.
