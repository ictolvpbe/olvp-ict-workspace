...
- **IP-plan VLAN 73 (2026-08-27)**: gateway `.1`, **statisch `.2`-`.99`**, **DHCP vanaf `10.70.4.100`**. UniFi deelde oorspronkelijk uit vanaf `10.70.4.11` → het geplande `10.70.4.20` lag **in de pool** en zou als lease aan iets anders gegeven worden. Pool ingekort i.p.v. het adres verplaatsen: negen vrije adressen is te weinig voor een VLAN met infrastructuur-interfaces. ⚠️ **User noemde dit netwerk eerst "VLAN 75"** — opnieuw een verspreking, bevestigd 73.
