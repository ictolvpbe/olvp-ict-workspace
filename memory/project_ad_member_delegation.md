...
**Runbook**: ✅ `platform-handbook/hosting/operations/delegate-ad-myschool-sync.md` — geschreven 2026-09-24. Tot dan bestond het niet, hoewel deze memory er sinds juni naar verwees; zie [[feedback-verify-memory-against-repo]].
...
**Sibling-runbook**: ✅ samengevoegd in hetzelfde document (`delegate-ad-myschool-sync.md`). RB-2026-AD-GRPMEMBER en RB-2026-AD-USERLIFECYCLE zijn in de praktijk één ingreep — zelfde bind-account, zelfde domein, zelfde dag, volledig overlappende caveats. Twee documenten die je alleen samen kan lezen zijn precies hoe de kruisverwijzing naar niet-bestaande bestanden ontstond.
